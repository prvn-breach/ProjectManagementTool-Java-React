...
public class BacklogController {
	...
	public Iterable<ProjectTask> findProjectBacklog(@PathVariable String backlog_id, Principal principal) {
		return projectTaskService.findBacklogById(backlog_id, principal.getName());
	}
	
	@GetMapping("/{backlog_id}/{pt_id}")
	public ResponseEntity<?> getProjectTaskByProjectSequence(@PathVariable String backlog_id, @PathVariable String pt_id, Principal principal) {
